...
// Create mapping between color code and color name
const colorMap = {
  'R': 'red',
  'O': 'orange',
  'G': 'green',
...
// Wall width takes up remaining space of canvas width. With 14 bricks
// and 13 2px gaps between them, that is 400 - (14 * 25 + 2 * 13) = 24px, so each
// wall will be 12px
const wallSize = 12;
const bricks = [];
